...
def download_grabpl_step():
    return {
        ...
        "commands": [
            ...
            '"{\\"body\\":\\"###   ❌ Failed to run Playwright plugin e2e tests <br /> Click [here](https://storage.googleapis.com/releng-pipeline-artifacts-dev/161658/playwright-report/index.html) to browse the Playwright report.<br />  <br /> For information on how to run Playwright tests locally, refer to the [Developer guide](https://github.com/grafana/grafana/blob/main/contribute/developer-guide.md#to-run-the-playwright-tests).\\"}"'
